import { difference1, difference2, difference3, difference4, difference5 } from '../difference/Alina/sandbox';

for (const solution of [difference1, difference2, difference3, difference4, difference5]) {
